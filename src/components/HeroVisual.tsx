      ...
      >
        <defs>
          <radialGradient id="hv-core" cx="38%" cy="32%">
            ...
            <stop offset="35%" stopColor="#f0d7a3" />
            <stop offset="70%" stopColor="#b07e3d" />
            <stop offset="100%" stopColor="#4a3217" />
          </radialGradient>
          <radialGradient id="hv-halo" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#d6a86b" stopOpacity="0.32" />
            <stop offset="45%" stopColor="#d6a86b" stopOpacity="0.08" />
            <stop offset="100%" stopColor="#d6a86b" stopOpacity="0" />
          </radialGradient>
          <radialGradient id="hv-coreGlow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#e5b97c" stopOpacity="0.65" />
            <stop offset="55%" stopColor="#e5b97c" stopOpacity="0.12" />
            <stop offset="100%" stopColor="#e5b97c" stopOpacity="0" />
          </radialGradient>
          <radialGradient id="hv-atom" cx="35%" cy="30%">
            <stop offset="0%" stopColor="#fff5e0" />
            <stop offset="55%" stopColor="#e5b97c" />
            <stop offset="100%" stopColor="#7a5728" />
          </radialGradient>
          ...
          <linearGradient id="hv-orbit-1" x1="0" y1="0" x2="600" y2="0">
            <stop offset="0%" stopColor="#d6a86b" stopOpacity="0" />
            <stop offset="35%" stopColor="#d6a86b" stopOpacity="0.65" />
            <stop offset="65%" stopColor="#d6a86b" stopOpacity="0.65" />
            <stop offset="100%" stopColor="#d6a86b" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="hv-orbit-2" x1="0" y1="0" x2="600" y2="0">
            <stop offset="0%" stopColor="#e5b97c" stopOpacity="0" />
            <stop offset="40%" stopColor="#e5b97c" stopOpacity="0.7" />
            <stop offset="60%" stopColor="#e5b97c" stopOpacity="0.7" />
            <stop offset="100%" stopColor="#e5b97c" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="hv-orbit-3" x1="0" y1="0" x2="600" y2="0">
            <stop offset="0%" stopColor="#f0d7a3" stopOpacity="0" />
            <stop offset="50%" stopColor="#f0d7a3" stopOpacity="0.7" />
            <stop offset="100%" stopColor="#f0d7a3" stopOpacity="0" />
          </linearGradient>
        </defs>
        ...
        <g>
          ...
          />
          <g>
            <circle cx="560" cy="300" r="24" fill="#d6a86b" opacity="0.14" />
        ...
        <g>
          ...
          />
          <g>
            <circle cx="540" cy="300" r="22" fill="#e5b97c" opacity="0.16" />
        ...
        <g>
          ...
          />
          <g>
            <circle cx="518" cy="300" r="20" fill="#f0d7a3" opacity="0.16" />
        ...
        <g>
          {[
            ...
            <circle key={i} cx={p.cx} cy="540" r={p.r} fill="#e5b97c">
              <animate
                attributeName="cy"
                from="560"
                to="60"
