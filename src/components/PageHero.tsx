        ...
        {bgImage ? (
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-5 relative mt-6 lg:mt-0 animate-fade-in delay-300">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-[var(--color-border)] bg-[var(--color-surface)] shadow-2xl aspect-[4/3] md:aspect-[16/10] lg:aspect-[4/3] group animate-float-slow">
